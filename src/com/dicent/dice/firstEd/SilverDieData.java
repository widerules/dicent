...
public class SilverDieData extends PowerDieData {
	...
	static {
		sideValues.put(Side.SIDE1, new SideValues(2));
		sideValues.put(Side.SIDE2, new SideValues(2));
		sideValues.put(Side.SIDE3, new SideValues(2));
		sideValues.put(Side.SIDE4, new SideValues(0, 0, 2));
		sideValues.put(Side.SIDE5, new SideValues(0, 0, 2));
